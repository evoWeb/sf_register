...
class Tx_SfRegister_ViewHelpers_Form_SelectStaticCountryZonesViewHelper extends Tx_Fluid_ViewHelpers_Form_SelectViewHelper {
	/**
	 ...
	 * @return void
	 */
	public function injectCountryRepository(Tx_SfRegister_Domain_Repository_StaticCountryZoneRepository $countryZonesRepository) {
	...
	public function initialize() {
		parent::initialize();
		if ($this->arguments->hasArgument('parent') && $this->arguments['parent'] != '') {
